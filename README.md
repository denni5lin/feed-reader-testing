...
In this project I was given a web-based application that reads RSS feeds. The original developer of this application clearly saw the value in testing, they've already included [Jasmine](http://jasmine.github.io/) and even started writing their first test suite! Unfortunately, that developer is no longer around so the task falls to me to complete the test suites.

## How to run this application

* Clone this repository by typing `git clone https://github.com/denni5lin/feed-reader-testing.git` into your command line.
* [Download](https://github.com/denni5lin/feed-reader-testing/archive/master.zip) this repository, upzip the file and open `index.html` file in any browser of your choice.
* Check it out on my GitHub Pages [**here**](https://denni5lin.github.io/feed-reader-testing/).
